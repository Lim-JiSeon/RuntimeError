...
document.querySelector('.img-box1 img').setAttribute('src', 'http://127.0.0.1:5500/HUFSummer%20Hackathon/MZ%EC%84%B8%EB%8C%80/images/image' + randomNumber + '.jpg');
document.querySelector('.img-box2 img').setAttribute('src', 'http://127.0.0.1:5500/HUFSummer%20Hackathon/MZ%EC%84%B8%EB%8C%80/images/image' + randomNumber + '.jpg');
